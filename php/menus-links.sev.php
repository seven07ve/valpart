...
function ingreso(){
	echo '<div class="ingreso">';
	 echo '<div class="boton-cuenta"><a href="" class="boton" ><i class="fa fa-sign-in"></i> Afiliarse</a></div> '."\n";
     echo '<div class="boton-cuenta"><a href="" class="boton" ><i class="fa fa-user"></i> Tu cuenta</a></div>'."\n";
	 echo '</div>';
}
...
function pie($lan,$pag){
	...
	if ($lan == ''){
		...
		<div class="col-foot"><a href="#">Afiliarse</a></div>
		<div class="col-foot"><a href="#">Atención al Cliente</a></div>
